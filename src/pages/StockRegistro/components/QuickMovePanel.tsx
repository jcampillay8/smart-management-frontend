...
export function QuickMovePanel() {
  ...
  return (
    <div className="flex flex-col h-full bg-card/30 backdrop-blur-xl border border-white/5 rounded-3xl overflow-hidden shadow-2xl animate-in slide-in-from-right duration-500">
      {/* Header del Panel */}
      ...
      <div className="p-6 space-y-8 flex-1">
        ...
        <div className="grid grid-cols-2 gap-2 p-1 bg-muted/30 rounded-2xl border border-white/5">
          ...
          >
            <ArrowDownLeft className={cn("h-4 w-4", mode === "in" ? "text-green-600" : "")} />
          ...
          >
            <ArrowUpRight className={cn("h-4 w-4", mode === "out" ? "text-red-600" : "")} />
        ...
        <div className="space-y-4">
          ...
          <div className="relative group">
            <Input 
              ...
              className="h-20 text-4xl font-mono font-black text-center bg-muted/20 border-white/5 rounded-2xl focus:ring-primary/20 transition-all"
            />
        ...
        <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-white/5 rounded-3xl bg-muted/10 gap-3">
      ...
      <div className="p-6 bg-muted/20 border-t border-white/5">
        ...
        <p className="mt-4 text-center text-[9px] text-muted-foreground font-medium uppercase tracking-tighter">
          Presiona <kbd className="px-1.5 py-0.5 rounded bg-white/10 border border-white/10 text-white">Enter</kbd> para ejecutar
        </p>
      </div>
    </div>
  );
